// Progression de l'explorateur : les XP gagnées en jouant font monter de rang,
// avec un titre à chaque palier. Donne un fil rouge motivant au-delà des étoiles.

export const XP_PAR_NIVEAU = 100;

const TITRES = ['Curieux', 'Éclaireur', 'Aventurier', 'Explorateur', 'Grand explorateur', "Chef d'expédition"];

export function niveauExplorateur(xp = 0) {
